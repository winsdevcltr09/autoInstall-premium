...
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/running.sh"
wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/cek-trafik.sh"
wget -q -O /usr/bin/cek-speed "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/speedtes_cli.py"
wget -q -O /usr/bin/cek-bandwidth "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/cek-bandwidth.sh"
wget -q -O /usr/bin/cek-ram "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/ram.sh"
wget -q -O /usr/bin/limit-speed "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/limit-speed.sh"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/menu-trojan.sh"
...
wget -q -O /usr/bin/menu-bckp "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/menu-bckp-github.sh"
#wget -q -O /usr/bin/bckp "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/bckpbot.sh"
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/usernew.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/kanghory/Autoscript-vpn-V1/main/menu.sh"
